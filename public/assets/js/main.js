...
(function () {
	...
	(function () {
	  ...
	  $form.addEventListener("submit", function (event) {
		...
		var newBackground = "url('images/characters/heroes/Superman.jpg')";
		var bgWrapper = document.querySelector("#bg");
		...
		if (!bgWrapper) {
		  ...
		  var currentBg = bgWrapper.querySelector(".visible:not(.top)");
		  if (currentBg) {
			window.setTimeout(function () {
